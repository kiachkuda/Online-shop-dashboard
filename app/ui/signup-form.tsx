    ...
    return (
        <form className="space-y-3" onSubmit={handleSubmit}>
            <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
                <h1 className={`${lusitana.className} mb-3 font-bold text-2xl`}>
                    Create an account
                </h1>
                ...
                <div className="w-full">
                    ...
                    <div className='flex flex-col '>
                        ...
                        <div className={clsx({ "hidden": !phoneError }, { "flex items-center space-x-1 p-2 text-sm w-full mt-3 rounded-md bg-red-500": phoneError })}>
                            <ExclamationCircleIcon className="h-4 w-4 text-white" />
                            <span className="text-white">{error}</span>
                        </div>
                    </div>
